    ...
    <tr>
        <td colspan="6"><? if ($navigation) : ?>
                ...
                <ul class="pager">
                    <? if ($navigation['first']) : ?>
                        <li class="first">
                            <a href="<?= SITE_URL; ?>tasks/page/1">First</a>
                        </li>
                    <? endif; ?>

                    <? if ($navigation['last_page']) : ?>
                        <li>
                            <a href="<?= SITE_URL; ?>tasks/page/<?= $navigation['last_page'] ?>">&lt;</a>
                        </li>
                    <? endif; ?>
                    ...
                    <? if ($navigation['previous']) : ?>
                        <? foreach ($navigation['previous'] as $val) : ?>
                            <li>
                                <a href="<?= SITE_URL; ?>tasks/page/<?= $val; ?>"><?= $val; ?></a>
                            </li>
                        <? endforeach; ?>
                    <? endif; ?>
                    ...
                    <? if ($navigation['next']) : ?>
                        <? foreach ($navigation['next'] as $v) : ?>
                            <li>
                                <a href="<?= SITE_URL; ?>tasks/page/<?= $v; ?>"><?= $v; ?></a>
                            </li>
                        <? endforeach; ?>
                    <? endif; ?>
                    <? if ($navigation['next_pages']) : ?>
                        <li>
                            <a href="<?= SITE_URL; ?>tasks/page/<?= $navigation['next_pages'] ?>">&gt;</a>
                        </li>
                    <? endif; ?>

                    <? if ($navigation['end']) : ?>
                        <li class="last">
                            <a href="<?= SITE_URL; ?>tasks/page/<?= $navigation['end'] ?>">Last</a>
                        </li>
                    <? endif; ?>
